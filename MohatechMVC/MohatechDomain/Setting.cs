...
namespace MohatechDomain
{
    public class Setting
    {
        ...
        [Display(Name = "آیکن")]
        [StringLength(200, MinimumLength = 4, ErrorMessage = "{0} باید بین {2} و {1} کاراکتر باشد")]
        ...
        [StringLength(100, MinimumLength = 2, ErrorMessage = "{0} باید بین {2} و {1} کاراکتر باشد")]
